...
public class DoubleOres extends IGamemode implements Listener{
    ...
    public boolean enableScenario() {
        ...
        instance.getGamemodeManager().setExtraOreAmount(1);
        setEnabled(true);
        return true;
    }
    @Override
    ...
    public void onBlockPlace(BlockPlaceEvent e){
        ...
        || e.getBlock().getType().equals(Material.GOLD_ORE)){
            e.setCancelled(true);
            e.getPlayer().sendMessage(ChatColor.RED + "DoubleOres Scenario do not allow this.");
        }
    }
    ...
    public void onBlockBreak(final BlockBreakEvent e) {
        ...
        switch (block.getType()) {
            ...
            case DIAMOND_ORE: {
                ...
                e.setDropItems(false);
                dropCenter(new ItemStack(Material.DIAMOND, (1+fortune)), block.getLocation());
            ...
            case EMERALD_ORE: {
                final int fortune = fortuneMultiplier(itemInHand);
                e.setDropItems(false);
                dropCenter(new ItemStack(Material.EMERALD, (1+fortune)), block.getLocation());
            ...
            case NETHER_QUARTZ_ORE: {
                final int fortune = fortuneMultiplier(itemInHand);
                e.setDropItems(false);
                dropCenter(new ItemStack(Material.QUARTZ, (1+fortune)), block.getLocation());
            ...
            case COAL_ORE: {
                final int fortune = fortuneMultiplier(itemInHand);
                e.setDropItems(false);
                dropCenter(new ItemStack(Material.COAL, (1+fortune)), block.getLocation());
